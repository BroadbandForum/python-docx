...
"""
Custom properties part, corresponds to ``/docProps/custom.xml`` part in
package.
"""
...
class CustomPropertiesPart(XmlPart):
    ...
    def default(cls, package):
        ...
        custom_properties.title = 'Word Document'
        custom_properties.last_modified_by = 'python-docx'
        custom_properties.revision = 1
        custom_properties.modified = datetime.utcnow()
